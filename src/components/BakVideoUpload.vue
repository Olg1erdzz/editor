<template>
  <div>
    <el-form ref="form" v-show="isOpenVideoForm" :model="submitVideoData" :rules="rules" label-width="80px">
      ...
      <el-form-item label="标签" prop="label">
        <el-select v-model="submitVideoData.label" placeholder="请选择视频标签">
          <el-option label="古籍识别" value="label1"></el-option>
        </el-select>
      </el-form-item>
    ...
    <el-upload :drag="Plus" :action="baseUrl + 'video/upload'" multiple show-file-list :data="submitVideoData" :on-success="handleVideoSuccess" :before-upload="beforeUploadVideo" :on-progress="uploadVideoProcess">
      ...
      <div v-if="Plus" class="el-upload__tip" slot="tip">只能上传mp4/flv/avi文件, 且不超过300M</div>
    </el-upload>
  </div>
</template>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        label: [{ required: true, message: "请选择视频标签", trigger: "change" }],
